...
load_pred = pd.read_csv('.\\loading_data\\'+species+'\\'+station+'_pred.csv').dropna()#loading in unit of kg
load_real = pd.read_csv('.\\loading_data\\'+species+'\\'+station+'_real.csv').dropna()#loading in unit of kg
...
#the first and last year may not be complete, close
...
annual_load['Annual_load_pred'] = loading.groupby('year')['load_pred_con'].sum()#loading in unit of kg
annual_load['Annual_load_real'] = loading.groupby('year')['load_real_con'].sum()#loading in unit of kg
